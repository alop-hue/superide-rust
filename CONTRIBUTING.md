# How to contribute
Thank you for your interest in contributing to SUPER IDE! No contribution is too small and we consider _all_ contributions to the project. There are many ways to contribute (a few are listed here) but if you think of something else, let us know via an [issue](https://github.com/lapce/lapce/issues).

## Questions

If you're participating on GitHub, you can open a [Discussion](https://github.com/lapce/lapce/discussions).

## Feature Requests

A feature request is _editor behaviour that you want to have included in SUPER IDE_. We track feature requests on GitHub via [issues](https://github.com/lapce/lapce/issues). There are generally few kinds of features:

### Core features

A feature more suited to the core development of SUPER IDE. If this is the case please make a suggestion in an [issue](https://github.com/lapce/lapce/issues).
