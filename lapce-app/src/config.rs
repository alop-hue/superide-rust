...
pub const LOGO: &str = include_str!("../../extra/images/superide/super_logo.svg");
...
const DEFAULT_SUPER_DARK_THEME: &str =
    include_str!("../../defaults/super-orange-dark.toml");
const DEFAULT_SUPER_LIGHT_THEME: &str =
    include_str!("../../defaults/super-orange-light.toml");
const DEFAULT_SUPER_HC_THEME: &str =
    include_str!("../../defaults/super-orange-hc.toml");
const DEFAULT_SUPER_GRADIENT_THEME: &str =
    include_str!("../../defaults/super-orange-gradient.toml");
const DEFAULT_SUPER_NEON_THEME: &str =
    include_str!("../../defaults/super-orange-neon.toml");
...
impl LapceConfig {
    ...
    fn load_color_themes(
        ...
        themes.insert(name.to_lowercase(), (name, theme));
        let (name, theme) =
            Self::load_color_theme_from_str(DEFAULT_SUPER_DARK_THEME).unwrap();
        themes.insert(name.to_lowercase(), (name, theme));
        let (name, theme) =
            Self::load_color_theme_from_str(DEFAULT_SUPER_LIGHT_THEME).unwrap();
        themes.insert(name.to_lowercase(), (name, theme));
        let (name, theme) =
            Self::load_color_theme_from_str(DEFAULT_SUPER_HC_THEME).unwrap();
        themes.insert(name.to_lowercase(), (name, theme));
        let (name, theme) =
            Self::load_color_theme_from_str(DEFAULT_SUPER_GRADIENT_THEME).unwrap();
        themes.insert(name.to_lowercase(), (name, theme));
        let (name, theme) =
            Self::load_color_theme_from_str(DEFAULT_SUPER_NEON_THEME).unwrap();
        themes.insert(name.to_lowercase(), (name, theme));
