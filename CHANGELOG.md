...
SUPER IDE is built on [Lapce](https://github.com/lapce/lapce). This changelog tracks Lapce upstream releases. SUPER IDE-specific changes are tracked separately.
